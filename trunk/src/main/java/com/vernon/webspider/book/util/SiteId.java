...
public enum SiteId {
	...
	QIQISHU {
		...
		public int getCategoryId(String name) {
			...
			} else if (name.equals("东方玄幻") || name.equals("异世大陆") || name.equals("奇幻架空")) {
				return Category.BookCategory.XH.ordinal();
			} else if (name.equals("西方奇幻") || name.equals("转世重生") || name.equals("王朝争霸") || name.equals("远古神话")) {
				return Category.BookCategory.XH.ordinal();
			} else if (name.equals("魔法校园") || name.equals("奇幻玄幻") || name.equals("吸血家族") || name.equals("变身情缘")) {
				return Category.BookCategory.XH.ordinal();
			} else if (name.equals("武侠仙侠") || name.equals("武侠修真") || name.equals("浪子异侠")) {
				return Category.BookCategory.WX.ordinal();
			} else if (name.equals("传统武侠") || name.equals("古典仙侠") || name.equals("历史武侠") || name.equals("谐趣武侠")) {
				return Category.BookCategory.WX.ordinal();
			} else if (name.equals("快意江湖") || name.equals("千千心结") || name.equals("品味人生")) {
				return Category.BookCategory.YQ.ordinal();
			} else if (name.equals("游戏生涯") || name.equals("网游动漫") || name.equals("虚拟网游") || name.equals("足球运动")) {
				return Category.BookCategory.WY.ordinal();
			} else if (name.equals("篮球运动") || name.equals("电子竞技") || name.equals("体育竞技") || name.equals("弈林生涯")) {
				return Category.BookCategory.WY.ordinal();
			...
			} else if (name.equals("历史军事") || name.equals("架空历史") || name.equals("战争幻想") || name.equals("三国梦想")) {
				return Category.BookCategory.LS.ordinal();
			} else if (name.equals("历史传记") || name.equals("现代战争") || name.equals("人文历史") || name.equals("特种军旅")) {
				return Category.BookCategory.LS.ordinal();
