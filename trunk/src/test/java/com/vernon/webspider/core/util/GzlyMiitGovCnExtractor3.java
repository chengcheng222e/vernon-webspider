 ...
 */
public class GzlyMiitGovCnExtractor3 extends Extractor {

    private static final Logger LOGGER = LoggerFactory.getLogger(GzlyMiitGovCnExtractor3.class);

    public GzlyMiitGovCnExtractor3(String encoding) {
        super(encoding);
    }
    ...
    public static void main(String[] args) throws Exception {
        Extractor extractor = new GzlyMiitGovCnExtractor3(Charset.UTF8.getValue());
        for (int page = 260; page <= 684; page ++) {
            extractor.loadPageNotProxy("http://bzxx.miit.gov.cn:8080/datainfo/miit/miit10148.jsp?page=" + page, Charset.UTF8);
            extractor.extract();
        }
    }
}
